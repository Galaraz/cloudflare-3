...
export default function Aluguel({list} ) {
    const { busca } = list
    ...
    return (
        <>
            ...
            <ListImoveis  data={busca} finalidadePagina={'Aluguel'} finalidadeId={1}/>
...
export async function getServerSideProps({ req, res, query }) {
    try {
      let body = JSON.stringify({
        acoes: [                        
          { metodo: "busca", params: [ { resultados: 12, ...query, ...{ finalidade : 1} }] },
        ], id: 328
      }) 
